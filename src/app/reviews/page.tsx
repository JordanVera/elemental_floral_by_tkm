      ...
      <section className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
        <div className="mx-auto mb-16 max-w-3xl text-center">
          ...
          <a
            ...
            className="mt-8 inline-flex items-center gap-2 bg-[#f59a88] px-8 py-3.5 text-xs tracking-[0.2em] text-black uppercase transition-colors duration-200 hover:bg-[#f8b5a8]"
          >

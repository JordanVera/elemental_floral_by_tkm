...
export const metadata: Metadata = {
  ...
  description:
    'Read Google reviews for Elemental Floral By TKM Designs — a 4.7★ Houston florist and art floral studio trusted by couples and event planners across Greater Houston.',
};
    ...
    <>
      ...
      <section className="relative h-64 overflow-hidden sm:h-80">
        ...
        <div className="relative z-10 flex h-full flex-col items-center justify-center px-6 pt-20 text-center">
          <p className="mb-4 text-[10px] tracking-[0.4em] text-[#539397] uppercase">
            Client Love
          </p>
      ...
      <section className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
        <div className="mx-auto mb-16 max-w-3xl text-center">
          ...
          <a
            ...
            className="mt-8 inline-flex items-center gap-2 bg-[#539397] px-8 py-3.5 text-xs tracking-[0.2em] text-black uppercase transition-colors duration-200 hover:bg-[#7eaeb1]"
          >
        ...
        <div className="mt-16 border border-[#539397]/30 bg-[#0e0c08] p-8 text-center sm:p-12">
          <p className="text-[10px] tracking-[0.35em] text-[#539397] uppercase">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="mt-8 inline-flex items-center gap-2 border border-white/30 px-8 py-3.5 text-xs tracking-[0.2em] text-white uppercase transition-colors duration-200 hover:border-[#539397] hover:text-[#539397]"
          >

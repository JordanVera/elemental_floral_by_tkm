...
export default function ServiceAreasNav({
  ...
  return (
    ...
    >
      ...
      {open ? (
        <div className="absolute left-1/2 top-full z-50 mt-2 w-56 -translate-x-1/2 overflow-hidden rounded-2xl border border-white/10 bg-[#0e0c08]/95 py-2 shadow-xl backdrop-blur-xl">
          <Link
            href={SERVICE_AREAS_INDEX.href}
